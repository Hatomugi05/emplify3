					...
					<div class="nav-mini-wrapper">
        				...
        				if ($user_online == true) {
        				    print '
        				        ...
        				        <li><a href="/sis-asistencia/vista/asistencia.php">Asistencia</a></li>';
        				} else {
        				    print '
        				        <li><a href="login.php">Ingresar</a></li>
        				        <li><a data-toggle="modal" href="#registerModal">Registrate</a></li>
        				        <li><a href="/sis-asistencia/">Asistencia</a></li>';
        				}
        				?>
    					</ul>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Dirección</h5>
										<address> Nuevo León, <br/>México <br/> </address>
								</li>
								<li>
										<h5>Correo Electrónico</h5><a href="mailto:al29900@edec.edu.mx">al29900@edec.edu.mx</a>
								</li>
				...
				<div class="main-footer">
					...
					<div class="container">
						...
						<div class="row">
							...
							<h5 class="footer-title">Contacto Emplify</h5>
						
							<p>Dirección : México-Nuevo León</p>
							<p>Correo Electrónico : <a href="mailto:al29900@edec.edu.mx">al29900@edec.edu.mx</a></p>
