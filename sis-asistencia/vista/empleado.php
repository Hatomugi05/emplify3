...
<div class="page-content">
  ...
  <a href="registro_empleado.php" class="btn btn-primary btn-rounded mb-2"><i class="fa-solid fa-plus"></i> &nbsp;Registarar</a>
              ...
              <div class="modal-body">
                <form action="" method="POST">
                  <div hidden class="fl-flex-label mb-4 px-2 col-12 ">
                    <input type="text" placeholder="ID" class="input iput__text" name="txtid" value="<?= $datos->id_empleado ?>">
                  </div>
